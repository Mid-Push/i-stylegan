...
def training_loop(
    ...
    while True:
        ...
        if (rank == 0) and (image_snapshot_ticks is not None) and (done or cur_tick % image_snapshot_ticks == 0):
            ...
            print('G_ema alive: ', (G_ema.mapping.importance>0.1).float().sum())
            print('G alive: ', (G.mapping.importance>0.1).float().sum())
            print(G_ema.mapping.importance)
            print(G.mapping.importance)
